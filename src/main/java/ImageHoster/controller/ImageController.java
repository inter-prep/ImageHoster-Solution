...
public class ImageController {
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session, RedirectAttributes redirectAttrs) {
        ...
        if(isImageOwnerInCurrentSession(imageId, session)) {
            ...
            redirectAttrs.addAttribute("editError", errorMsg).addFlashAttribute("editError", errorMsg);
    ...
    private Boolean isImageOwnerInCurrentSession(Integer imageId, HttpSession session) {
        ...
        return currentUserId.equals(imgOwnerId);
    }
}
